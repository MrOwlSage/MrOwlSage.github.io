...
![3](../assets/img/objc4-906-debug/3.png)
...
```
![2](../assets/img/objc4-906-debug/2.png)
### 补充缺失文件
...
![4](../assets/img/objc4-906-debug/4.jpg)
...
直接注释掉相关代码即可
![5](../assets/img/objc4-906-debug/5.jpg)

9.'sandbox/private.h' file not found
直接注释掉相关引用即可
![6](../assets/img/objc4-906-debug/6.jpg)

10.Use of undeclared identifier 'CRGetCrashLogMessage'
直接注释相关代码即可
![7](../assets/img/objc4-906-debug/7.jpg)

11.Use of undeclared identifier 'SANDBOX_FILTER_PATH'
直接注释相关代码即可
![8](../assets/img/objc4-906-debug/8.jpg)

12.'Cambria/Traps.h' file not found
直接注释掉引用
![9](../assets/img/objc4-906-debug/9.jpg)

13.'Cambria/Cambria.h' file not found
直接注释掉引用
![10](../assets/img/objc4-906-debug/10.jpg)
...
注释掉相关引用
![11](../assets/img/objc4-906-debug/11.jpg)

19.'os/feature_private.h' file not found
注释掉相关引用
![12](../assets/img/objc4-906-debug/12.jpg)

20.'os/log_simple_private.h' file not found
注释掉相关引用
![13](../assets/img/objc4-906-debug/13.jpg)
...
![15](../assets/img/objc4-906-debug/15.jpg)
...
![16](../assets/img/objc4-906-debug/16.jpg)

接着添加依赖库
![18](../assets/img/objc4-906-debug/18.jpg)
